...
public interface EnrollmentRecordService {
	...
	int updateByExampleSelective(@Param("record") EnrollmentRecord record,
			@Param("example") EnrollmentRecordExample example);
