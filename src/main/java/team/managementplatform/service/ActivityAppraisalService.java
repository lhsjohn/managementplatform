...
public interface ActivityAppraisalService {
	...
	int updateByExampleSelective(@Param("record") ActivityAppraisal record,
			@Param("example") ActivityAppraisalExample example);

	int updateByExampleWithBLOBs(@Param("record") ActivityAppraisal record,
			@Param("example") ActivityAppraisalExample example);
